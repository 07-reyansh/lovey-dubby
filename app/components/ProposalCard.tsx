                ...
                <div className="boarding-pass relative rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1a2e] to-[#16213e] border border-glass-border shadow-xl">
                  ...
                  <div className="flex items-center justify-between px-5 py-3">
                    <div className="text-center">
                      <p className="text-2xl sm:text-3xl font-extrabold text-white">BLR</p>
                      <p className="text-[10px] text-gray-500 mt-0.5">Bangalore</p>
                    </div>
                    ...
                    <div className="text-center">
                      <p className="text-2xl sm:text-3xl font-extrabold text-white">IDR</p>
                      <p className="text-[10px] text-gray-500 mt-0.5">Indore</p>
                    </div>
                  </div>
